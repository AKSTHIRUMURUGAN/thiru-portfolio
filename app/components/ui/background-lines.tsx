"use client";
import { cn } from "@/lib/utils"; // Ensure you have this utility or replace it with a simple classNames function
...
export const BackgroundLines = ({
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen h-full w-full bg-black overflow-hidden",
        className
      )}
    >
