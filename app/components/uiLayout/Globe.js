    ...
    <>
      <div className="h-screen overflow-hidden bg-black text-white">
        <article className="grid gap-4 text-center relative z-10 pt-10">
          ...
          <h1 className="text-xl sm:text-4xl  font-semibold bg-gradient-to-b from-[#edeffd] to-[#7b9cda] bg-clip-text text-transparent leading-[100%] tracking-tighter">
          👋 Hey there! 
            <br />
            You’ve just stepped into Thirumurugan's digital universe
            <br/>
            a blend of passion, innovation, and achievements.
          </h1>
          <Earth />
        </article>
